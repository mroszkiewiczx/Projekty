...
-- FIXED 2026-06-08: profiles -> users, workspace_members -> users (workspace_id col)
create table if not exists public.export_history (
  ...
  error_message text,
  records_count integer, -- ile rekordow wyeksportowano
...
-- Indexes
create index if not exists idx_export_history_workspace on public.export_history(workspace_id);
